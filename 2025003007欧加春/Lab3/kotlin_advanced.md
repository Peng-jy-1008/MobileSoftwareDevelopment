...
// 测试代码
fun main() {
    val song = Song("love story", "Adele", 2015, 5000000)
...
```kotlin
fun main() {
    val amanda = Person("oujiahun", 24, "play tennis", null)
    val atiqah = Person("wyq", 24, "climb", amanda)
